...
compositores = ['Spielberg','Hichcock','Felini','Welles','Kubrick','Griffith','Eisenstein']
caracteristicas = ['I-F','F-R','F-H','L-D','I-D','R-A','T-M','A-M']
...
nn = n.loadtxt('notas_diretores.txt')
